...
import com.example.powerstrentgh.Developer.TrainerPanel.AdapterClass.ConFrimUserForMealTrainnerAdapter;
...
import com.example.powerstrentgh.databinding.FragmentCreateWorkoutForMemberBinding;
...
public class CreateWorkoutForMemberFragment extends Fragment {
   ...
   private FragmentCreateWorkoutForMemberBinding binding;
    private ConFrimUserForMealTrainnerAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCreateWorkoutForMemberBinding.inflate(getLayoutInflater(),container,false);
        mAuth = FirebaseAuth.getInstance();
        user = mAuth.getCurrentUser();
        if (user != null) {
            String currentUserId = user.getUid();
            list = new ArrayList<>();
            adapter = new ConFrimUserForMealTrainnerAdapter(list, requireActivity(),currentUserId);
