...
public class UnProvedTrainnerToAdminFragment extends Fragment {

    private FragmentUnProvedTrainnerToAdminBinding binding;
    ...
    public UnProvedTrainnerToAdminFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentUnProvedTrainnerToAdminBinding.inflate(getLayoutInflater(),container,false);
        list = new ArrayList<>();
