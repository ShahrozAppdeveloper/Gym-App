...
import com.example.powerstrentgh.AdapterSchedule;
...
public class TrainerCreateWorkout extends Fragment {
    ...
    private void trainerscedules(View view,String userid) {
        ...
        if (userid != null) {
            list = new ArrayList<>();
            adapterSchedule = new AdapterSchedule(getContext(), list);
